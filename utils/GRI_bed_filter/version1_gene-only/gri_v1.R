...
hgmd_hg38 = "HGMD_Pro_2022.2_hg38.vcf.gz"
hgmd_hg19 = "HGMD_Pro_2022.2_hg19.vcf.gz"
...
if (genome_version == "hg38") {
  ...
  ##load hgmd data
  hgmd_data <- readVcf(hgmd_hg38, genome = "hg38")
  ...
  ##load hgmd data
  hgmd_data <- readVcf(hgmd_hg19, genome = "hg19")
