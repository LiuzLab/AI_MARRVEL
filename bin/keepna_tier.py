...
def feature_engineering(score_file, tier_file):
    ...
    patient.loc[patient["gnomadAFg"] == "-", "gnomadAFg"] = patient.loc[
        patient["gnomadAFg"] == "-", "gnomadAF"
    ]  # 0.0 #
    patient.loc[patient["gnomadAFg"] == ".", "gnomadAFg"] = patient.loc[
        patient["gnomadAFg"] == ".", "gnomadAF"
    ]  #
    patient.loc[patient["gnomadAF"] == "-", "gnomadAF"] = patient.loc[
        patient["gnomadAF"] == "-", "gnomadAFg"
    ]  # 0.0 #
    patient.loc[patient["gnomadAF"] == ".", "gnomadAF"] = patient.loc[
        patient["gnomadAF"] == ".", "gnomadAFg"
    ]
    ...
    # conservationScoreOELof
    patient.loc[patient["conservationScoreOELof"] == "-", "conservationScoreOELof"] = (
        np.NaN
    )
    patient.loc[
    ...
    patient.loc[patient["Polyphen2_HVAR_score"] == -100, "Polyphen2_HVAR_score"] = (
        np.NaN
    )
    ...
    patient.loc[patient["MutationAssessor_score"] == -100, "MutationAssessor_score"] = (
        np.NaN
    )
    ...
    tier_vars = [
        ...
        "AD.matched",
        "AR.matched",
        "OMIM.Inheritance.recessive",
        "OMIM.Inheritance.dominant",
        "OMIM.Inheritance.both",
        "OMIM.Inheritance.others",
    ]
